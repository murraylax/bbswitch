...
\begin{titlepage}
\begin{singlespace}
\title{Regime Switching and Wages in Major League Baseball under the Reserve Clause\footnote{For very helpful comments, we would like to thank Kevin Quinn, David Surdam, and the participants at the following conferences: Cliometrics Society session of WEAI 2010 annual meeting, Economic and Business Historical Society 2011 annual conference, and the 7th BETA Workshop in Historical Economics.  We would also like to thank Jake Kimmet, Tony Lyga, and Eric Streske for valuable research assistance.  All errors are our own.}}
\date{May 17, 2011}
\author{
Michael Haupert\footnote{\textit{Mailing address}: 1725 State St., La Crosse, WI  54601. \textit{Phone}: (608)785-6863.\newline  \textit{E-mail}: haupert.mich@uwlax.edu.}\\Department of Economics\\University of Wisconsin - La Crosse
\and
